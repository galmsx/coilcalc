...
----------------------------------------------------------------------------------------------------
handle = openfile(C*1000000 .. "-" .. TruDpr .. "-" .. CoilsAmount .. "-" .. Lkat*1000  .. "-" .. Lsdv*1000 .. "-".. Vykl .. "-".. Rdsc .. " V-" .. Vel .. " KPD-" .. KPD .. " Vm-" .. Vmax .. "E-" .. dEpuli ..  ".txt", "a")-- создаем файл а - будем дописывать в конец файла w - записать стерев всё что было перед тем
