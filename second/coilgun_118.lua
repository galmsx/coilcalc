...
Dkat = ((CoilsAmount*2*Dpr)+10) 	-- Внешний диаметр катушки, милиметр
...
----------------------------------------------------------------------------------------------------
handle = openfile(C*1000000 .. "-" .. TruDpr .. "-" .. CoilsAmount .. "-" .. Lkat*1000  .. "-" .. Lsdv*1000 .. " V-" .. Vel .. " KPD-" .. KPD .. " Vm-" .. Vmax .. "E-" .. dEpuli ..  ".txt", "a")-- создаем файл а - будем дописывать в конец файла w - записать стерев всё что было перед тем
